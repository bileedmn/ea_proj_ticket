INSERT INTO usercredentials(username,password,enabled) VALUES ('guest','guest', TRUE);
INSERT INTO usercredentials(username,password,enabled) VALUES ('admin','admin', TRUE);
